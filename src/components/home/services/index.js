...
import Facial from "../../../images/services/facial1.jpg";

function Services() {
  const services = [
    { name: 'Nail Enhancements', serviceImg: NailImg },
    // { name: 'Manicures', serviceImg: ManiImg },
    { name: 'Manicures & Pedicures', serviceImg: PediImg },
    { name: 'Anti-Aging Facial', serviceImg: Facial },
    // { name: 'Power Repair', serviceImg: DipImg },
    { name: 'Waxing', serviceImg: WaxImg },
    { name: 'Eyelash Extensions', serviceImg: LashImg },
    { name: "Kids' Service", serviceImg: KidImg },
  ];
  return (
    <div className="py-32">
